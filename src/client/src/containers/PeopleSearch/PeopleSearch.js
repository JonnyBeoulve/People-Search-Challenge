...
class PeopleSearch extends Component {
  ...
  handlePeopleSearchSubmit = e => {
    ...
    axios
      ...
      .then(res => {
        if (res.data.datafinder.results) {
    ...
    return (
      <div className="people-search">
        <form
          ...
          onSubmit={this.handlePeopleSearchSubmit}
        >
          <div className="people-search-form-input">
            <label>FirstName</label>
            <input
              className="people-search-fname"
              type="text"
              name="email"
              label="FirstName"
              placeholder="eg. John"
          ...
          <div className="people-search-form-input">
            <label>State</label>
            <input
              className="people-search-usstate"
              type="text"
              name="password"
              placeholder="eg. LA"
              disabled={this.state.loading}
          ...
          <button
            className="people-search-form-submit"
            type="submit"
            value="Submit"
            disabled={this.state.loading}
          >
        ...
        <div className="people-search-body">
          ...
          {this.state.searchData &&
            this.state.searchData.map((person, index) => {
              return (
                <PersonSearchResult
                  key={person.phone}
                  resultNum={index + 1}
